...
def upgrade():
    ...
    op.create_table('text_area_field',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('data', sa.Unicode(length=255), nullable=True),
    sa.Column('media_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['media_id'], ['media.id'], ),
...
def downgrade():
    ...
    op.drop_table('picture_field')
    op.drop_table('pages')
    op.drop_table('number_field')
    op.drop_table('menu_fields')
    op.drop_table('link_field')
